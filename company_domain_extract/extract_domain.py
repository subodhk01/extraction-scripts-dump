...
def domain_search_1(company_name):
...
def domain_search_2(company_name):
...
def search_domain(company_name):
    domains = []
    domains.append(domain_search_1(company_name))
    domains.append(domain_search_2(company_name))
    domains = [domain for domain in domains if domain is not None]
    return domains

print(search_domain('Squarepoint Capital'))